!function (e, r) {
  ...
  var e = {
    en: {
      ...
      email: 'Это поле должно быть похоже на e-mail',
      number: 'Здесь должны быть цифры',
      integer: 'В этом поле должны быть целые числа',
      url: 'Это поле должно быть похоже на URL',
      tel: 'Это поле должно быть похоже на номер телефона',
      maxlength: 'Максимальная длина строки < ${1}',
      minlength: 'Минимальная длина строки > ${1}',
